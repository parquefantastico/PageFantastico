      ...
      <div class="table-responsive col-sm-12">    
        <table id="dt_pyt" class="table table-bordered table-hover" cellspacing="0" width="100%">
          <thead>
            ...
            <th>Correo Rlectronico</th>
            <th># de Eventos</th>
              <th ><a href="nuevocliente.php" class="btn btn-primary">Nuevo Cliente</a> </th>                    
            </tr>
          </thead>          
        </table>
      </div>      
      ...
      var table = $("#dt_pyt").DataTable({
          ...
          "columns":[
                 ...
                 {"data":"nombre"},
                  ...
                  {"data":"correo_e_cli"},
                  {"data":"num_evento"},
                  {render: function (data, type, row){return `<a class="btn btn-primary" href="Detalleticket.php?id=${row.id_clientes}" role="button">Detalle de cliente </a> <a   class="btn btn-danger" onclick="comprobarcontra(${row.id_clientes});" >Editar Cliente</a>`}}
